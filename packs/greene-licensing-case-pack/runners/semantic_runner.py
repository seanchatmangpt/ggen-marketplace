...
judges greene-licensing-case-pack witnesses against greene-licensing-case-pack
gates.
...
Semantics:
  pass  -- witness graph must SHACL-conform against ontology/shapes.ttl
           (with ontology.ttl -- the glc: packet vocabulary -- mixed in as the
           ontology graph) AND return zero rows from every
           gate in gates/.
