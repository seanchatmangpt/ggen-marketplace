#!/usr/bin/env bash
# T03 invalid corpus — refusal assertion: missing-ontology
# Law: RFC-GPACK-001 v26.9.17 §6 — only pack.toml and ontology.ttl are
# REQUIRED by GGEN-PACK-CORE; a pack whose semantic graph is absent is
# REFUSED:PACK_GRAPH_MISSING (Appendix C).
#
set -u
