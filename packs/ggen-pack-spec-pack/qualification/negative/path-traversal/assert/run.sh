#!/usr/bin/env bash
# T03 invalid corpus — refusal assertion: path-traversal
# Law: RFC-GPACK-001 v26.9.17 §71 — a conforming implementation MUST prevent
# pack-controlled paths from escaping admitted roots (.. traversal is the
# §96 "Path safety" falsifier). Expected: REFUSED:PACK_PATH_ESCAPE.
#
set -u
