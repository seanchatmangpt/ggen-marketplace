#!/usr/bin/env bash
# T03 invalid corpus — refusal assertion: manifest-semantic-identity-mismatch
# Law: RFC-GPACK-001 v26.9.17 §8 — admission requires Project(I_S) == I_B; a
# disagreement between the bootstrap manifest identity and the semantic graph
# identity is REFUSED:PACK_IDENTITY_MISMATCH.
#
set -u
