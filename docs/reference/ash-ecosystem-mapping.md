...
| **`ash_surface`** | `26.9.13` (Target) | MX Consumer Surface (`XaaS/Ash -> AshSurface_MX -> ZOELA`). Emits typed observation, action, planning, event, and receipt envelopes. | [`experience-projection-pack`](file:///Users/sac/ggen-marketplace/packs/experience-projection-pack), [`deterministic-dynamic-ui-pack`](file:///Users/sac/ggen-marketplace/packs/deterministic-dynamic-ui-pack), [`patterns/fond-hddl-mx-loop`](file:///Users/sac/ggen-marketplace/patterns/fond-hddl-mx-loop) |
